                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          <div class="breadcomb-report">
                            <!--<a href="../reportes/rptarticulos.php"><button data-toggle="tooltip" data-placement="left" title="Reporte" class="btn"><i class="icon nalika-download"></i></button></a> centro-->
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="product-status-wrap">
                      <h4>Lista de proveedores</h4>
                        <div class="add-product">
                          <div class="breadcomb-report">
                            <a target="_blank"><button data-toggle="tooltip" data-placement="left" title="" class="btn" onclick="mostrarform(true)" id="btnagregar">Agregar Proveedor</button></a>
                            <br>
                           <div class="breadcomb-report">
                        </div>
